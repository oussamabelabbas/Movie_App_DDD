...
class WishlistMoviesBuilder extends StatelessWidget {
  const WishlistMoviesBuilder({Key? key}) : super(key: key);
                        ...
                        child: Column(
                          ...
                          children: [
                            ListTile(
                              ...
                              title: Center(child: Text("Mark watched")),
                            ),
                            SizedBox(height: 8.0),
                            ListTile(
                              shape: StadiumBorder(),
                  ...
                  if (delete != null) {
                    if (delete) {
                      ...
                      context.read<MovieActorBloc>().add(
                          MovieActorEvent.updateState(movies[index], true));
                    }
                  }
                },
